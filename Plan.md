...
- **Ollama remains the default cognitive backend.** The in-process llama.cpp
  backend is available behind a flag for future tuning (e.g. GPU-accelerated
  clip / `MTMDChatHandler`).
